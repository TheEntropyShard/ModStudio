...
package me.theentropyshard.modstudio.language;
...
public class MapLanguageSection implements LanguageSection {
    ...
    public String getString(String key) {
        ...
        if (lastDotIndex == -1) {
            ...
            if (s == null) {
                System.err.println("Section does not contain string for key: " + key);
    ...
    public LanguageSection getSection(String key) {
        ...
        if (section == null) {
            System.err.println("Could not find section by key: " + key);
