...
import me.theentropyshard.modstudio.utils.datatransfer.TransferableFile;
import me.theentropyshard.modstudio.utils.datatransfer.TransferableImage;
...
public enum OperatingSystem {
    ...
    public static boolean isMacApp() {
        return OperatingSystem.isMacOS() &&
            Files.isDirectory(ModStudio.getInstance().getWorkDir().getParent().resolve("MacOS"));
    }
