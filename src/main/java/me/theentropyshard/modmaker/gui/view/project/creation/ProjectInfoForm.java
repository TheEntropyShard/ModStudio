...
public class ProjectInfoForm extends JPanel {
    ...
    public ProjectInfoForm() {
        ...
        this.locationComponent = new ProjectLocationComponent("untitled", ModMaker.getInstance().getProjectsDir());
        ...
        SwingUtils.addChangeListener(this.nameField, e -> {
            ...
            this.locationComponent.updateText(this.nameField.getText(), ModMaker.getInstance().getProjectsDir());
        });
    }
